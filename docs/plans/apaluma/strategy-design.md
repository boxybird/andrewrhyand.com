...
- **"Senior full-stack engineer, frontend-leaning"** as the lead — mirrors the job title language without sycophantic copying.
...
- A `/resume` page that renders the resume content as a digital, linkable artifact — doubles as a frontend craft demo.
